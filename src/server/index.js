...
import GraphQlGeneesplaats from "./ssr/";
...
console.log(
    "7777777777777777777777777777 src/server/index.js 777777777777777777777777777777777777777777"
);
        ...
        case "subscriptions":
            Loadable.preloadAll().then(() => {
                server.listen(PORT ? PORT : 8000, () => {
                    console.log(
                        "Listening on port " + (PORT ? PORT : 8000) + "!"
                    );
