...
.. list-table::
   ...
   * - ``log-format``
     ...
     - See the `template file <https://github.com/nginxinc/kubernetes-ingress/blob/v1.8.0/internal/configs/version1/nginx.tmpl>`_ for the access log.
     - 
   * - ``log-format-escaping``
   ...
   * - ``stream-log-format``
     ...
     - See the `template file <https://github.com/nginxinc/kubernetes-ingress/blob/v1.8.0/internal/configs/version1/nginx.tmpl>`_.
     - 
...
.. list-table::
   ...
   * - ``opentracing``
     ...
     - ``False``
     - `Support for OpenTracing <https://github.com/nginxinc/kubernetes-ingress/blob/v1.8.0/examples/opentracing/README.md>`_.
   * - ``opentracing-tracer``
